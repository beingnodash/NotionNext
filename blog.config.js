...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '56b35f44a7104401afe8300f9520b98c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到七座桥, Hi，欢迎一起领略复杂管理科学,Hi，欢迎跳出舒适区',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Valor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '管理者的第二大脑', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://7bridge.link', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '管理, 科普', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,twitter,telegram,messenger,line,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'Valor官方博客', // 站点描述，被notion中的页面描述覆盖
